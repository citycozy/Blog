...
public class MemberFacade {
    ...
    public MemberFacade(MemberCommandService memberCommandService, MemberQueryService memberQueryService) {
    ...
    public MemberResponse.GetMember getLoginMember(){
        ...
        return MemberResponse.GetMember.of(member.getId(), member.getEmail(), member.getNickname(), member.getRole());
    }
}
